...
<CardGroup cols={2}>
  <Card title="Edit Your Docs" icon="pen-to-square" color="#645DFF" href="https://mintlify.com/docs/quickstart">
    Get your docs set up locally for easy development
  </Card>
  <Card title="Preview Changes" icon="image" color="#645DFF" href="https://mintlify.com/docs/development">
