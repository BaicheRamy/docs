...
## 🌐 What is the Virtual Visitor?

The Virtual Visitor is a **built-in simulation environment** that allows you to:

* Preview how your chat widget behaves
* Test Triggers, Flows, and Aura AI responses
* Validate Forms, Data Requests, and Updates
* Iterate safely without impacting real users

It’s especially useful for:

* QA engineers and developers validating logic
* Support teams testing AI or fallback behavior
* Designers checking widget appearance across themes
...
3. Use the URL bar above to simulate page visits (e.g., `/checkout`, `/help`, etc.)
