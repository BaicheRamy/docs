---
title: "Profiles: Understanding Your Customer in Real-Time"
...
<CardGroup cols={2}>
  ...
  <Card title="Dynamic Routing & Automation" icon="route">
    Use profile attributes (e.g., `department_interest`, `product_tier`) as conditions in your [<u>Triggers</u>](/Features/Triggers)[ ](/Features/Triggers)or [<u>Flows</u>](/Features/Flows)[ ](/Features/Flows)to route chats to the correct department or agent, or to initiate specific automated messages.
  </Card>
</CardGroup>
