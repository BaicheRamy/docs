...
Emplorium enables powerful integrations with external APIs using **Data Requests** and **Data Updates**, giving your AI assistant (Aura AI) the ability to fetch and send data in real-time during conversations. This section outlines how to set up and manage both features effectively.
...
> \[add\_image\_here] – Data Request configuration panel
...
> \[add\_image\_here] – Data Update mapping screen
...
> \[add\_image\_here] – Trigger keyword assignment UI
