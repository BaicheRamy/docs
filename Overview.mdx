...
<CardGroup cols={2}>
  <Card title="Set Up Emplorium" icon="wand-magic-sparkles" href="quickSetup">
    Quick guide to installing Emplorium and embedding your widget.
  </Card>
  <Card title="Learn About Aura AI" icon="robot" href="/features/auraai">
    Understand how to configure AI responses and escalate issues smartly.
  </Card>
  <Card title="Create Your First Flow" icon="bolt" href="/features/Flows">
    Automate actions based on triggers and user behavior.
  </Card>
  <Card title="Connect Your Tools" icon="plug" href="/features/integrations">
...
If you have any questions or need help, our [support team](#open-widget-emp) is always here for you.